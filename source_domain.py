...
def get_source_data():
    ...
    # Load dataset
    source_data = pd.read_csv("/media/linuxdata/rr35021174/ITL-Github/Dataset/source_dataset_west.csv")
    ...
    # Step 5: Handle 'Sleep Duration' (convert categorical to numeric)
    ...
    # Step 6: Standardize Numerical Features (Z-score normalization)
    ...
    # print("Training set size:", X_train_source.shape)
    # print("Testing set size:", X_test_source.shape)

    # # Step 1: Initialize and train the Gaussian SVM (RBF kernel)
    ...
    rf_model = joblib.load('/media/linuxdata/rr35021174/ITL-Github/Trained_BB_models/gsvm_model_source.pkl')
    # Step 2: Make predictions on the test set
    # y_pred_source = rf_model.predict(X_test_source)
    # y_prob_source = rf_model.predict_proba(X_test_source)[:, 1]  # Probabilities for AUC (positive class)
