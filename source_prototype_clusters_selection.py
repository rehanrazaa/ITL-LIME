...
def get_source_cluster_instances():
    ...
    # Apply K-means or K-mediod clustering on the entire dataset (Note: Here the K-mean will return real prototypes)
    ...
    # get source real instances under the selected clusters
